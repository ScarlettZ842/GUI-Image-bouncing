...
public class A1 extends JFrame {
    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        ImageIcon polygonIcon = createImageIcon("small-rainbow.gif");
        shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {ovalButtonIcon,recangletButtonIcon,squareButtonIcon,spatternButtonIcon, pieButtonIcon, polygonIcon } );
        ...
        ImageIcon unknownIcon = createImageIcon("unknown.gif");
        pathComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {fallButtonIcon, bounceButtonIcon, unknownIcon});
