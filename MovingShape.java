...
public abstract class MovingShape {
    ...
    public class wavyPath extends MovingPath {
    	private double scale = 0, t =0, sinDeltax = 0;
       ...
       public void move() {
           sinDeltax = sinDeltax + t;
           topLeft.y = (int) Math.round(topLeft.y + scale * Math.sin(sinDeltax));
           topLeft.x = topLeft.x + deltaX;
           
           if (topLeft.x < 0) {
           		topLeft.x = 0;
           		deltaX = -deltaX;	
           } else if (topLeft.x > marginWidth) {
        	   deltaX = -deltaX;	
        	   topLeft.x = marginWidth-width;
           }
       } 
